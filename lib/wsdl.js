...
var WSDLElement = function(nsName, attrs, options) {
...
WSDLElement.prototype._initializeOptions = function (options) {
  if(options) {
...
WSDLElement.prototype.deleteFixedAttrs = function() {
...
WSDLElement.prototype.allowedChildren = [];

WSDLElement.prototype.startElement = function(stack, nsName, attrs, options) {
...
WSDLElement.prototype.endElement = function(stack, nsName) {
...
WSDLElement.prototype.addChild = function(child) {
  return;
};

WSDLElement.prototype.unexpected = function(name) {
  throw new Error('Found unexpected element (' + name + ') inside ' + this.nsName);
};

WSDLElement.prototype.description = function(definitions) {
  return this.$name || this.name;
};

WSDLElement.prototype.init = function() {
};

WSDLElement.createSubClass = function() {
  var root = this;
...
var ElementElement = WSDLElement.createSubClass();
var AnyElement = WSDLElement.createSubClass();
var InputElement = WSDLElement.createSubClass();
var OutputElement = WSDLElement.createSubClass();
var SimpleTypeElement = WSDLElement.createSubClass();
var RestrictionElement = WSDLElement.createSubClass();
var ExtensionElement = WSDLElement.createSubClass();
var ChoiceElement = WSDLElement.createSubClass();
var EnumerationElement = WSDLElement.createSubClass();
var ComplexTypeElement = WSDLElement.createSubClass();
var ComplexContentElement = WSDLElement.createSubClass();
var SimpleContentElement = WSDLElement.createSubClass();
var SequenceElement = WSDLElement.createSubClass();
var AllElement = WSDLElement.createSubClass();
var MessageElement = WSDLElement.createSubClass();
var DocumentationElement = WSDLElement.createSubClass();

var SchemaElement = WSDLElement.createSubClass();
var TypesElement = WSDLElement.createSubClass();
var OperationElement = WSDLElement.createSubClass();
var PortTypeElement = WSDLElement.createSubClass();
var BindingElement = WSDLElement.createSubClass();
var PortElement = WSDLElement.createSubClass();
var ServiceElement = WSDLElement.createSubClass();
var DefinitionsElement = WSDLElement.createSubClass();
...
WSDLElement.prototype.description = function(definitions, xmlns) {
  var element = {},
    name = this.$name;
    ...
    if (top) {
      try {
        ...
        if (self.options.strict) {
          ...
          stack.push(new WSDLElement(nsName, attrs, options));
        }
      }
    } else {
      name = splitQName(nsName).name;
...
function open_wsdl(uri, options, callback) {
  ...
  var wsdl;
  if (!/^https?:/.test(uri)) {
    throw new Error('Non-URL WSDL is not supported in browser');
  }
